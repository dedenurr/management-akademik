...
func SetupRouter(DB *sql.DB) *gin.Engine {
	...
	// === jwt
		...
		auth.GET("/dosens", dosenController.ReadDosen)
		...
		auth.GET("/mahasiswas",  mahasiswaController.ReadMahasiswa)
		...
		auth.GET("/matakuliahs",  mataKuliahController.ReadMataKuliah)
		...
		auth.GET("/perkuliahans",  perkuliahanController.ReadPerkuliahan)
